# =========================================================
# 🧠 MEGABOT CODE UNDERSTANDING LAYER v3
# =========================================================
...
def save(result):
    ...
    try:
        ...
        os.system('git config --global user.email "megabot@bot.ai"')
        os.system('git config --global user.name "megabot"')

        os.system("git add code_understanding.json")
...
def run():
    ...
    log(f"BRAIN: {summary['brain_candidates']}")
    log(f"EXEC: {summary['execution_candidates']}")
